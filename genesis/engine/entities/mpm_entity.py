...
class MPMEntity(ParticleEntity):
    ...
    def _add_to_solver(self):
        ...
        if isinstance(self.material, gs.materials.MPM.Muscle):
            self.set_particles_muscle_group(self.mesh_set_group_ids)
    ...
    def process_input(self, in_backward=False):
        ...
        if self._tgt["actu"] is not None:
            ...
            self.set_particles_actu(self._tgt["actu"], particles_idx_local, envs_idx)
    ...
    def get_particles_pos(self, envs_idx=None, *, unsafe=False):
        ...
        self.solver._kernel_get_particles_pos(
            self._sim.cur_substep_local, self._particle_start, self.n_particles, poss, envs_idx
        )
        return poss
    ...
    def get_particles_vel(self, envs_idx=None, *, unsafe=False):
        ...
        self.solver._kernel_get_particles_vel(
            self._sim.cur_substep_local, self._particle_start, self.n_particles, vels, envs_idx
        )
        return vels
    ...
    def get_particles_active(self, envs_idx=None, *, unsafe=False):
        ...
        self.solver._kernel_get_particles_active(
            self._sim.cur_substep_local, self._particle_start, self.n_particles, actives, envs_idx
        )
        return actives
    ...
    def set_particles_actu(self, actus, envs_idx=None, *, unsafe=False):
        ...
        self._set_particles_target_state("actu", "actuation", (self.material.n_groups,), actus, envs_idx, unsafe=True)

    @assert_muscle
    @gs.assert_built
    def _set_particles_actu(self, actus, particles_idx_local, envs_idx):
        """
        ...
        self.solver._kernel_set_particles_actu(
            self._sim.cur_substep_local, self._particle_start, self._n_particles, self.material.n_groups, envs_idx, actu
        )

    @gs.assert_built
    def _set_particles_actu_grad(self, actu_grad, envs_idx):
        """
    ...
    def get_particles_actu(self, envs_idx=None, *, unsafe=False):
        ...
        self.solver._kernel_get_particles_actu(
            self._sim.cur_substep_local, self._particle_start, self.n_particles, actus, envs_idx
        )
        return actus

    @assert_muscle
    @gs.assert_built
    def set_particles_muscle_group(self, muscle_group):
        """
        ...
        assert isinstance(max_group_id, int) and max_group_id < self.material.n_groups
        self.solver._kernel_set_particles_muscle_group(self._particle_start, self._n_particles, muscle_group)

    @assert_muscle
    @assert_active
    @gs.assert_built
    def get_particles_muscle_group(self):
        """
    ...
    @assert_active
    @gs.assert_built
    def set_particles_muscle_direction(self, muscle_direction):
        """
        ...
        self.solver._kernel_set_particles_muscle_direction(self._particle_start, self._n_particles, muscle_direction)

    def set_particles_muscle(self, muscle_group=None, muscle_direction=None):
        """
        ...
        if muscle_group is not None:
            self.set_particles_muscle_group(muscle_group)

        if muscle_direction is not None:
            self.set_particles_muscle_direction(muscle_direction)
    ...
    def set_free(self, free):
        ...
        """
        self.solver._kernel_set_free(self._particle_start, self._n_particles, free)
    ...
    def get_free(self):
        ...
        self.solver._kernel_get_free(self._particle_start, self._n_particles, free)
        return free
