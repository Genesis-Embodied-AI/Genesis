...
def get_rigid_global_info(solver):
    ...
    return StructRigidGlobalInfo(
        ...
        mass_mat=V(dtype=gs.ti_float, shape=(solver.n_dofs_, solver.n_dofs_, _B), needs_grad=requires_grad),
        mass_mat_L=V(dtype=gs.ti_float, shape=(solver.n_dofs_, solver.n_dofs_, _B), needs_grad=requires_grad),
