...
def test_diff_solver(monkeypatch):
    from genesis._engine.solvers.rigid.constraint.solver import func_solve_init, func_solve_body
    from genesis._engine.solvers.rigid.rigid_solver import kernel_step_1
