...
from genesis._engine.entities import DroneEntity, RigidEntity
from genesis._engine.entities.base_entity import Entity
from genesis._engine.states import QueriedStates, RigidSolverState
...
if TYPE_CHECKING:
    ...
    from genesis._engine.entities.rigid_entity import RigidJoint, RigidLink, RigidGeom, RigidVisGeom
...
class RigidSolver(Solver):
    ...
    def build(self):
        ...
        if self._static_rigid_sim_config.requires_grad:
            ...
            from genesis._engine.couplers import SAPCoupler, IPCCoupler
    ...
    def substep(self, f):
        ...
        from genesis._engine.couplers import SAPCoupler
    ...
    def substep_pre_coupling(self, f):
        if self.is_active:
            ...
            from genesis._engine.couplers import IPCCoupler
    ...
    def get_AABB(self, entities_idx=None, envs_idx=None):
        from genesis._engine.couplers import LegacyCoupler
