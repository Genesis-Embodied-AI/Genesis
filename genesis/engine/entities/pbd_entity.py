...
class PBDTetEntity(ParticleEntity):
    ...
    def process_input(self, in_backward=False):
        raise NotImplementedError("This function was not implemented for now.")
    ...
    def get_particles_pos(self, envs_idx=None, *, unsafe=False):
        ...
        self.solver._kernel_get_particles_pos(self._particle_start, self.n_particles, poss, envs_idx)
        return poss
    ...
    def get_particles_vel(self, envs_idx=None, *, unsafe=False):
        ...
        self.solver._kernel_get_particles_vel(self._particle_start, self.n_particles, vels, envs_idx)
        return vels

    @gs.assert_built
    def _set_particles_active(self, actives, particles_idx_local, envs_idx):
        self.solver._kernel_set_particles_active(particles_idx_local + self._particle_start, envs_idx, active)
    ...
    def get_particles_active(self, envs_idx=None, *, unsafe=False):
        ...
        self.solver._kernel_get_particles_active(self._particle_start, self.n_particles, actives, envs_idx)
        return actives
