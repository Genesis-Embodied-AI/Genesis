        ...
        for i_b in range(_B):
            ...
            for i_d in range(n_dofs):
                ...
                for j_d in range(i_d):
                    z -= constraint_state.nt_L[i_b, i_d, j_d] * constraint_state.bw_r[j_d, i_b]
                z /= constraint_state.nt_L[i_b, i_d, i_d]
            ...
            for i_d_ in range(n_dofs):
                ...
                for j_d in range(i_d + 1, n_dofs):
                    u -= constraint_state.nt_L[i_b, j_d, i_d] * constraint_state.bw_u[j_d, i_b]
                u /= constraint_state.nt_L[i_b, i_d, i_d]
