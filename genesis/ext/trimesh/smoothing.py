...
def filter_laplacian(
    mesh, lamb=0.5, iterations=10, implicit_time_integration=False, volume_constraint=True, laplacian_operator=None
):
    """
    ...
    for _index in range(iterations):
        ...
        if volume_constraint:
            ...
            vol_new = triangles.mass_properties(vertices[faces], skip_inertia=True)["volume"]
...
def filter_mut_dif_laplacian(mesh, lamb=0.5, iterations=10, volume_constraint=True, laplacian_operator=None):
    """
...
def laplacian_calculation(mesh, equal_weight=True, pinned_vertices=None):
    ...
    if equal_weight:
        ...
        norms = [
            1.0 / np.maximum(1e-6, np.sqrt(np.dot((vertices[i] - vertices[n]) ** 2, ones)))
