...
DofsState = qd.template()
DofsInfo = qd.template()
GeomsState = qd.template()
GeomsInfo = qd.template()
GeomsInitAABB = qd.Tensor
LinksState = qd.template()
LinksInfo = qd.template()
JointsInfo = qd.template()
JointsState = qd.template()
VertsState = qd.template()
VertsInfo = qd.template()
EdgesInfo = qd.template()
FacesInfo = qd.template()
VVertsInfo = qd.template()
VFacesInfo = qd.template()
VGeomsInfo = qd.template()
VGeomsState = qd.template()
EntitiesState = qd.template()
EntitiesInfo = qd.template()
EqualitiesInfo = qd.template()
RigidGlobalInfo = qd.template()
ColliderState = qd.template()
ColliderInfo = qd.template()
MPRState = qd.template()
MPRInfo = qd.template()
SupportFieldInfo = qd.template()
ConstraintState = qd.template()
GJKState = qd.template()
GJKInfo = qd.template()
SDFInfo = qd.template()
ContactIslandState = qd.template()
DiffContactInput = qd.template()
RigidAdjointCache = qd.template()
RaycastResult = qd.template()
