...
class IPCCoupler(RBC):
    ...
    Note
    ----
    Paper reference: https://ipc-sim.github.io/
    Code reference: https://github.com/squarefk/FastIPC
    """
    ...
    def __init__(
        ...
        self._n_ipc_iterations = options.n_ipc_iterations
        self._ipc_threshold = options.ipc_threshold
        ...
        # TODO Add more options for IPC, such as friction, d, tau. etc.
    ...
    def init_ipc_fields(self):
        # Fields for ipc solver
        # TODO change this as needed
    ...
    def init_linesearch_ccd_fields(self):
        # TODO implement
        pass
    ...
    def couple_grad(self, f):
        gs.raise_exception("couple_grad is not available for IPCCoupler. Please use Coupler instead.")
    ...
    def fem_floor_detection(self, f: ti.i32):
        # TODO change this accordingly to IPC
        fem_solver = self.fem_solver
    ...
    def ipc_solve(self, f):
        self.init_ipc_solve(f)
        # the previous result generated by the FEM solver is used as the initial guess and may contain penetration
        # Need ccd to move back
        self.linesearch_ccd(f)
        for i in range(self._n_ipc_iterations):
    ...
    def init_ipc_solve(self, f: ti.i32):
    ...
    @ti.kernel
    def linesearch_ccd(self, f: ti.i32):
        # TODO add ccd for IPC
        pass
