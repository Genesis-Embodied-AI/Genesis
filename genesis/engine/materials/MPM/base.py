...
class Base(Material["MPMEntity"]):
    ...
    # Subclasses that only use F_tmp (e.g. non-viscous liquid, neohooken elastic) set this to
    # False so the solver can skip the SVD kernel for scenes where no material needs it.
