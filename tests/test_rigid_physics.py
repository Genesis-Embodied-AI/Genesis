...
def test_drone_hover_same_with_and_without_substeps(show_viewer, tol):
    base_rpm = 15000
    scene_ref = gs.Scene(show_viewer=show_viewer, sim_options=gs.options.SimOptions(dt=0.002, substeps=1))
    ...
    scene_test = gs.Scene(show_viewer=show_viewer, sim_options=gs.options.SimOptions(dt=0.01, substeps=5))
