...
class SAPCoupler(RBC):
    ...
    def build(self) -> None:
        ...
        if self.rigid_solver.is_active:
            ...
            validity = self.rigid_solver.collider._collider_info.collision_pair_validity.to_numpy()
            self.rigid_collision_pair_validity = ti.field(gs.ti_int, shape=validity.shape)
            self.rigid_collision_pair_validity.from_numpy(validity)
