...
class ConstraintSolver:
    def __init__(self, rigid_solver: "RigidSolver"):
        ...
        self.len_constraints = (
            5 * rigid_solver.collider.collider_global_info._max_contact_pairs[None]
    ...
    def add_collision_constraints(self):
        ...
        for i_b in range(self._B):
            for i_col in range(self._collider.collider_global_info.n_contacts[i_b]):
                contact_data = self._collider.collider_global_info.contact_data[i_col, i_b]
    ...
    def _func_update_contact_force(self):
        ...
        for i_b in range(self._B):
            ...
            for i_c in range(self._collider.collider_global_info.n_contacts[i_b]):
                contact_data = self._collider.collider_global_info.contact_data[i_c, i_b]
                ...
                self._collider.collider_global_info.contact_data[i_c, i_b].force = force
