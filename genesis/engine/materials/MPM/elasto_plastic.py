...
class ElastoPlastic(Base):
    ...
    Note
    ----
    Default yield ratio comes from the SNOW material in gstaichi's MPM implementation: https://github.com/taichi-dev/gstaichi_elements/blob/d19678869a28b09a32ef415b162e35dc929b792d/engine/mpm_solver.py#L434
