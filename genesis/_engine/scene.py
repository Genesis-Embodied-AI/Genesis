...
from genesis._engine.force_fields import ForceField
from genesis._engine.materials.base import Material
from genesis._engine.states.solvers import SimState
...
class Scene(RBC):
    ...
    def add_emitter(
        ...
        """
        from genesis._engine.entities import Emitter
