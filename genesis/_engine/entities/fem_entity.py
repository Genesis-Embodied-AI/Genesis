...
from genesis._engine.entities.rigid_entity import RigidLink
from genesis._engine.couplers import SAPCoupler
from genesis._engine.states.cache import QueriedStates
from genesis._engine.states.entities import FEMEntityState
...
class FEMEntity(Entity):
    ...
    def __init__(
        ...
        from genesis._engine.materials.FEM.cloth import Cloth as ClothMaterial
