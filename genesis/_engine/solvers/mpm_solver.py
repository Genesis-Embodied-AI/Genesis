...
from genesis._engine.boundaries import CubeBoundary
from genesis._engine.entities import MPMEntity
from genesis._engine.states.solvers import MPMSolverState
...
if TYPE_CHECKING:
    ...
    from genesis._engine.solvers.base_solver import Solver
