...
def _func_parallel_linesearch_eval(
    ...
    for i_flat in range(_B * _K):
        ...
        if active:
            ...
            # post-linesearch cost kernel), then runs the monolith's bracketing walk + 3-alpha
            # dual-bracket refinement to converge precisely.
            #
            ...
            # 3. Bracketing walk + 3-alpha refinement instead of bisection — bisection converges
            #    to suboptimal zero-crossings on piecewise-quadratic cost functions.
            if tid == 0:
                constraint_state.candidates[0, i_b] = 0.0
