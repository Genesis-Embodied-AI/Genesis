...
def convert_heightfield_to_watertight_trimesh(
    ...
    for i in range(num_rows - 1):
        ...
        # Triangulate along the diagonal (i+1,j)<->(i,j+1) to match the collision mesh built by
        # func_contact_mpr_terrain in narrowphase.py. The opposite diagonal would surface up to one
        # vertical_scale of mismatch between the rendered terrain and the contact surface.
