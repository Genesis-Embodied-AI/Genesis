...
class Elastic(Base):
    ...
    Note
    ----
    Reference for the default values of `E` and `nu`: https://github.com/taichi-dev/gstaichi_elements/blob/d19678869a28b09a32ef415b162e35dc929b792d/engine/mpm_solver.py#L201
