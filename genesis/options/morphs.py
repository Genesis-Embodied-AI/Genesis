...
class Stage(FileMorph):
    """
    This is the base class for all stage morphs.

    A stage morph represents a complete scene or stage loaded from a file format that supports hierarchical scene descriptions.

    Note
    ----
    This class should *not* be instantiated directly. Use concrete implementations such as `gs.morphs.USDStage` instead.
