...
from genesis._engine.states.entities import RigidEntityState
...
class RigidEntity(Entity):
    ...
    def inverse_kinematics_multilink(
        ...
        from genesis._engine.solvers.rigid.abd.inverse_kinematics import kernel_rigid_entity_inverse_kinematics
