...
class RigidSimStaticConfig(metaclass=AutoInitMeta):
    ...
    # Register-tile width for the Hessian Cholesky kernels: 16 (Tile16x16) or 32 (Tile32x32).
    # Selected at build time based on n_dofs: 32 wins for large problems (e.g. dex_hand, n_dofs=62);
    # 16 wins when n_dofs is small or lands in a padding-unfavorable band (e.g. g1_fall, n_dofs=35).
    # See perso_hugh/doc/cholesky_tile32_2026may22.md for the box_pyramid sweep + dispatch model.
